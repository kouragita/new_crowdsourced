...
const Homepage = () => {
  ...
  const [featuresRef, featuresInView] = useInViewObserver({ threshold: 0.1 });
  const [leaderboardRef, leaderboardInView] = useInViewObserver({ threshold: 0.1 });
  const [testimonialsRef, testimonialsInView] = useInViewObserver({ threshold: 0.1 });
